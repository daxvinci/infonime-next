...
const Navbar = () => {
        const {darkmode,setSearchValue=()=>{},user} = useThemeContext()
      ...
      <>
        ...
        >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="right-nav-mobile flex items-center gap-4 sm:hidden">
              <button
              ...
              >
               ...
               <Link href="/profile"> 
                <Image
                  className="size-8 profile-img hover:cursor-pointer rounded-full"
                  src="/images/id_invaded.webp"
                  width={30}
                  height={30}
                  alt="profile img"
                />
          ...
          <div className="nav-links hidden sm:flex sm:justify-between sm:flex-row gap-6 sm:w-[50%]">
            ...
            <div className="search w-[90%] sm:w-[60%]">
              <input
                className={`outline-none border ${
                  darkmode ? "placeholder:text-gray" : "placeholder:text-black"
                } placeholder:italic rounded-2xl w-full px-2 py-1 ring-blue-500`}
                type="search"
                name="search"
                placeholder="search..."
                id="search"
            ...
            <div className="profile-section sm:min-w-[20%] flex items-center gap-2">
              <Link href="/profile">
                <Image
                  className="size-8 profile-img hover:cursor-pointer rounded-full"
                  src="/images/id_invaded.webp"
              ...
              <h3 className="text-xl profile-name max-w-[100px] truncate">
