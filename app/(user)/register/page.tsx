...
const AdminRegister = () => {
  ...
  return (
    <>
      <div className="flex min-h-screen gym-bg flex-col items-center relative justify-center px-6 py-12 lg:px-8">
        <div className="register-wallpaper absolute z-10 inset-0" />
        <div className="register-overlay bg-black/40 absolute z-20 inset-0" />
        <div className="backdrop-blur-lg relative z-30 bg-white/10 border border-white/30 shadow-xl rounded-2xl p-8 w-full max-w-md">
